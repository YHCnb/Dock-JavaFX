...
//    }
    ...
    public void showButton5Content() {
        ...
        about1.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                Text text=new Text("    这是一个旨在Windows上便携化管理电脑应用程序的Dock栏软件，灵感来源于Mac苹果Dock以及类似产品。借助这个应用，你可以随意地对自己的常用软件进行管理、运行等操作，它将给你直观高颜值的应用界面，人性化的响应事件以及高度自由化的个人偏好设置。由此，我们希望您在这里获得一个更加简洁的桌面，以及更加高效的办公体验，祝您体验愉快！");
        ...
        about4.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                Text text=new Text("这里首先特别感谢金老师对于我们的很多无法解决的问题的悉心回答，也给出了很多有帮助的指导。我们因新冠的缘故报告没能按时写完，金老师也同意我们晚提交一段时间，才让我们的项目能够最终顺利地完成，真的十分感谢。同时也感谢王大神对菜鸡陈同学的不离不弃和大力扶持，给王大神磕一个头  (((m -__-)m");
                text.setFont(Font.font("微软雅黑",FontWeight.MEDIUM,13));
                text.setWrappingWidth(218);
                showSmallStage(text,stage);
            }
